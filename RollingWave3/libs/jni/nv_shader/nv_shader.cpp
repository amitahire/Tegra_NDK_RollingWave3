...
GLint nv_load_program(const char *prog, const char *prepend)
{
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "nv_shader",  "cBINDING", filename);
...
GLint nv_load_program_from_strings(const char *vertStr, const char *fragStr)
{
	...
	//__android_log_print(ANDROID_LOG_DEBUG, "Location Position:", "%f",(float)loc);

	//loc = glGetAttribLocation(program,"colour");

	//__android_log_print(ANDROID_LOG_DEBUG, "Location colour:", "%f",(float)loc);
	//////////////////////////////////////////
    glLinkProgram(program);
    glsl_log(program, GL_LINK_STATUS);
	...
	//__android_log_print(ANDROID_LOG_DEBUG, "nv_shader-INFO", "Printed INFO about active attributes.");
	//__android_log_print(ANDROID_LOG_DEBUG, "nv_shader-INFO", "%f",(float)len);
    return program;
}
